...
data = np.load('raw/scan_5_50_70_-70_-1_70.npz')
...
fig3.tight_layout()
fig4.tight_layout()
fig1.savefig('plots/W.png', bbox_inches='tight', dpi=fig1.dpi)
fig2.savefig('plots/T.png', bbox_inches='tight', dpi=fig2.dpi)
fig3.savefig('plots/F.png', bbox_inches='tight', dpi=fig3.dpi)
fig4.savefig('plots/Delta.png', bbox_inches='tight', dpi=fig4.dpi)
...
def chern_and_gap(raw, name, rect=None, newthresh=1.5):
    ...
    fig1.tight_layout()
    fig2.tight_layout()
    fig1.savefig('plots/' + name + 'C.png', bbox_inches='tight', dpi=fig1.dpi)
    fig2.savefig('plots/' + name + 'Delta.png', bbox_inches='tight', dpi=fig2.dpi)

chern_and_gap('raw/scan_-50_50_70_-70_70_70.npz', 'triagb0_', [av[0,0], bv[0,0], av[-1,-1] - av[0,0], bv[-1,-1] - bv[0,0]])
chern_and_gap('raw/scan_50nm_-30_30_70_-42_42_70.npz', 'triag50nm_')
...
def single(raw, name):
    ...
    fig1.tight_layout()
    fig2.tight_layout()
    fig1.savefig('plots/' + name + 'bands.png', bbox_inches='tight', dpi=fig1.dpi)
    fig2.savefig('plots/' + name + 'berry.png', bbox_inches='tight', dpi=fig2.dpi)
